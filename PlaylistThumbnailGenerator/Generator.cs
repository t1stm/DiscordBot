...
public class Generator
{
    ...
    private static void GenerateImageEntry(string? textToWrite, int x, int y, MagickReadSettings settings,
        IMagickImage image)
    {
    ...
    private static void GeneratePlaylistImage(MagickImage? overlayImage)
    {
        if (overlayImage == null)
            throw new NullReferenceException(
                $"Variable \'{nameof(overlayImage)}\' in AddPlaylistImage method is null.");
