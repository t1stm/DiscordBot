...
namespace BatToshoRESTApp.Tools
{
    ...
    {
        public static bool CheckIfEmoji(string file, out List<DiscordEmoji> emojisToBeUsed)
        {
            emojisToBeUsed = new List<DiscordEmoji>();
            emojisToBeUsed = file.Trim() switch
            {
                "4_5793984356309535296.mp4" => new List<DiscordEmoji>
                {
                    DiscordEmoji.FromGuildEmote(Bot.Clients[0], 832171323438006320)
                },
                "7.mp4" or "523k0jtx65a61.jpg" or "image0_301.png" or "yes_bite.mp4" or
                    ...
                    "rat-cursed.mp4" => new List<DiscordEmoji> {DiscordEmoji.FromName(Bot.Clients[0], ":question:")},
                "the_he.mp4" or "image0-2.jpg" or "image0_173.png" or "image3_19.jpg" or "image0_216.jpg" or
                    "image0_358.jpg" => new List<DiscordEmoji> {DiscordEmoji.FromName(Bot.Clients[0], ":tired_face:")},
                "bag.mp4" => new List<DiscordEmoji>
                {
                    DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_u:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_h:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_i:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_t:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_s:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":telephone:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":family_man_girl:")
                },
                "video0_443.mp4" or "j9b1bc47pn241.png" or "video0_250.mp4" or "image.jpg" or "please_mom.png" or
                    ...
                    {
                        DiscordEmoji.FromName(Bot.Clients[0], ":cry:")
                    },
                "im_straight.mp4" or "image1.png" or "Hifumi_Yugoslav.mp4" or "video0_710.mp4" =>
                    new List<DiscordEmoji> {DiscordEmoji.FromName(Bot.Clients[0], ":flag_rs:")},
                "arco_mac_1331037748204101635320P_1.mp4" or "os3jol60i6a61.jpg" or
                    ...
                    {
                        DiscordEmoji.FromName(Bot.Clients[0], ":heart_eyes:")
                    },
                "teletubbies.mp4" => new List<DiscordEmoji>
                {
                    DiscordEmoji.FromName(Bot.Clients[0], ":green_square:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":red_square:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":yellow_square:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":blue_square:")
                },
                ...
                "1603629602444.webm" => new List<DiscordEmoji> {DiscordEmoji.FromName(Bot.Clients[0], ":ship:")},
                "video0_216.mp4" or "video0_34.mp4" or "video0_596.mp4" => //Mickey Mouse Club
                    new List<DiscordEmoji>
                    {
                        DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_o:"),
                        DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_h:"),
                        DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_n:"),
                        DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_o:")
                    },
                "IMG_20210303_213310.jpg" or "bc66a1a.jpg" or "video0_261_new_jam.mp4" => new List<DiscordEmoji>
                {
                    DiscordEmoji.FromGuildEmote(Bot.Clients[0], 833334153775939634),
                    DiscordEmoji.FromGuildEmote(Bot.Clients[0], 832215075276193862)
                },
                "video0_302.mp4" or "monkeyveilcity.mp4" => new List<DiscordEmoji>
                {
                    DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_y:"),
                    DiscordEmoji.FromName(Bot.Clients[0], ":regional_indicator_a:"),
                    DiscordEmoji.FromGuildEmote(Bot.Clients[0], 833337593299075102)
                },
                _ => emojisToBeUsed
            };
            return emojisToBeUsed.Count >= 1;
        }
    }
}