...
The file starts with the bytes (0-255) 84,7,70,60 (which is an easter egg that spell BatTo6o)  (6 is read like sh in Bulgarian when used in a word, this is the so called scholkavica - шльокавица)
